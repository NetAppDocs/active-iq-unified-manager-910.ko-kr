...
다음 섹션에서는 관리자가 Unified Manager 웹 UI에 표시되는 스토리지 성능 문제를 해결하기 위해 수행할 수 있는 몇 가지 일반적인 워크플로우에 대해 설명합니다.
...
다음 섹션에서는 유지 관리 콘솔에 액세스하고 이를 사용하여 Unified Manager 서버 기능과 관련된 문제를 해결하기 위한 지침을 제공합니다.
